const ICON_MAP = {
  chicken_meat: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Chicken_Meat.png'),
  beef: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Beef.png'),
  pork: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Pork_Meat.png'),
  lamb: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Lamb_Meat.png'),
  turkey: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Turkey_Meat.png'),
  deli_meats: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Deli_Meats.png'),
  hamburger: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Hamburgers.png'),
  other_meat: require('@/src/Food_Categories_Icons/Meat_&_Meat_Products/categories_Other_Meat.png'),
  fish: require('@/src/Food_Categories_Icons/Fish_&_Seafood/categories_Fish.png'),
  seafood: require('@/src/Food_Categories_Icons/Fish_&_Seafood/categories_Seafood.png'),
