...
/** Interpret habit timer fields as seconds. Prefers durationMinutes, falls back to target+unit. */
export function timerTargetToSeconds(habit) {
  if (habit.durationMinutes != null) {
    return Math.round(Math.max(1, Number(habit.durationMinutes) || 1) * 60);
  }
